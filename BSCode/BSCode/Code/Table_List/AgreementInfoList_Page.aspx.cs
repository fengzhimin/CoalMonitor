...
{
    public partial class AgreementInfoList_Page : System.Web.UI.Page
    {
    ...
    // GridViewID.DataSource=ggfgf;
        ...
        public void bind()
        {
            m_allRecord = m_OperateAgreementInfo.getAllAgreementInfo();
            ...
            string _SQL = "select * from tb_AgreementInfo";
