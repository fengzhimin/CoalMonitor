<%@ Page Language="C#" EnableEventValidation = "false" AutoEventWireup="true" CodeBehind="CarCheckInfoList_Page.aspx.cs" Inherits="BSCode.Code.Table_List.CarCheckInfoList_Page" %>
     ...
     <script type="text/javascript">
         $(document).ready(function () {
             ...
             $("a#edit_link").fancybox({
                 ...
                 'onClosed': function () {
                     window.location.href = '../Table_List/CarCheckInfoList_Page.aspx';
                 }
             });
             ...
             $("a#picture_link").fancybox({
                 ...
                 'showCloseButton': false,
                 'onClosed': function () {
                     window.location.href = './CarCheckInfoList_Page.aspx';
                 }
             });
         });
    </script>
...
<body>
    ...
    <div style="overflow-y: scroll; height: 90%;width:100%" id="dvBody">
        ...
        <asp:DropDownList ID="search_DropDownList" runat="server">
            <asp:ListItem>车卡号</asp:ListItem>
        </asp:DropDownList>
        ...
        <input type="checkbox" id="search_option" runat="server" class="search_option_checkBox" />
        ...
        <asp:GridView  ID="GridViewID" width="100%" runat="server" AllowPaging="true" PageSize="10" AutoGenerateColumns="False" CellPadding="4"
                ...
                OnRowDataBound="GridViewID_RowDataBound" OnPageIndexChanging="GridViewID_PageIndexChanging">
        <RowStyle BackColor="#FFFBD6" ForeColor="#333333" />
            ...
            <Columns>
                ...
                <asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="合同ID">
                     <ItemTemplate>
                         <asp:Label ID="Label_agreementID" runat="server" Text='<%# Eval("agreementNo") %>' CssClass="Middlelength" title='<%# Eval("agreementNo")%>'></asp:Label>
                     </ItemTemplate>
                 </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="车牌号">
                 ...
                 <asp:TemplateField HeaderText="空车体积">
                     <ItemTemplate>
                         <asp:Label ID="Label_emptyCarSize" runat="server" Text='<%# Eval("emptyCarSize") %>' CssClass="Minlength" title='<%# Eval("emptyCarSize")%>'></asp:Label>
                     </ItemTemplate>
                 </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="车标重">
                     <ItemTemplate>
                         <asp:Label ID="Label_CarWeight" runat="server" Text='<%#  Eval("CarWeight") %>' CssClass="Minlength" title='<%# Eval("CarWeight")%>'></asp:Label>
                     </ItemTemplate>
                 </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="拉货地点">
                     <ItemTemplate>
                         <asp:Label ID="Label_weighPlace" runat="server" Text='<%#  Eval("weighPlace") %>' CssClass="Middlelength" title='<%# Eval("weighPlace")%>'></asp:Label>
                     </ItemTemplate>
                 </asp:TemplateField>
                <asp:TemplateField HeaderText="是否违规">
                     <ItemTemplate>
                         <asp:Label ID="Label_abnormal" runat="server" Text='<%#  Eval("abnormal") %>' CssClass="Middlelength" title='<%# Eval("abnormal")%>'></asp:Label>
                     </ItemTemplate>
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="进/出">
                     <ItemTemplate>
                         <asp:Label ID="Label_inOut" runat="server" Text='<%#  Eval("inOut") %>' CssClass="Middlelength" title='<%# Eval("inOut")%>'></asp:Label>
                     </ItemTemplate>
                 </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="编辑">
                    <ItemTemplate>
                        ...
                        <a href="../Table_Edit/CarCheckInfoEdit_Page.aspx?ID=<%#DataBinder.Eval(Container.DataItem, "ID")%>" id="edit_link">编辑</a>
                    </ItemTemplate>
                </asp:TemplateField>
