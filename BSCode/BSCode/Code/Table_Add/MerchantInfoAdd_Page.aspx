<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantInfoAdd_Page.aspx.cs" Inherits="BSCode.Code.Table_Add.MerchantInfoAdd_Page" %>
...
<body>
        ...
        <div class="form-bak">
            <form id="Form1" method="post" runat="server" action="#" onsubmit="adaptValue();">
                    ...
                    <div class="line" id="line_merchantCardID">
                        ...
                        <div class="input">
                             <asp:TextBox ID="_merchantCardID" runat="server" 
                                 placeholder="商户卡号" disable="disabled" ReadOnly ="true"></asp:TextBox>                     
                             <div class="none"><span></span></div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                     <asp:Button ID="add_button" type="button" class="ui_input_btn01" style="margin-left:40%" runat="server" Text="添加" onclick="add_button_Click" />
                    <input id="Button1" class="ui_input_btn01" type="button"  value="重置" style="margin-right:40%;" runat="server" onclick="MerchantInfoResetVerify()"/>&nbsp;
